...
Seguro.prototype.cotizarSeguro = function() {
    ...
    */
    ...
    // Cada aÃ±o de diferencia hay que reducir 3% el valor del seguro
    cantidad -= ((diferencia * 3) * cantidad) / 100;
    /*
        Si el seguro es bÃ¡sico se mÃºltiplica por 30% mas
...
Interfaz.prototype.mostrarMensaje = function(mensaje, tipo) {
    ...
    formulario.insertBefore(div, document.querySelector('#resultado')); // Nuevo Nodo y referencia... // Si la referencia no existe se aÃ±adira al final
...
// Imprime el resultado de la cotizaciÃ³n
Interfaz.prototype.mostrarResultado = function(seguro, total) {
    ...
    div.innerHTML = `
        ...
        <p class="font-bold">AÃ±o: <span class="font-normal"> ${seguro.anio} </span> </p>
